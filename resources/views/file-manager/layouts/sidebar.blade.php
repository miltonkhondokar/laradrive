            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item" data-toggle="modal" data-target="#createFileModule" >
                            <a href="#" class="nav-link active">
                                <i class="nav-icon far fa-file"></i>
                                <p>File</p>
                            </a>
                        </li>
                        <li class="nav-item" data-toggle="modal" data-target="#createFolderModule" >
                ...
                {{--<li class="nav-item">--}}
                    {{--<a href="{{ url('/') }}" class="nav-link"  id="ChangeFolderIcon">--}}
